<?php include_once '../controller/ERP_PEN_COM_IMP.php';?>
<script type="text/javascript" src="../js/ERP_PEN_VEN_IMP.js"></script>
<div class="container">
	<div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Pendientes de imputaci&oacute;n de compras</h3>
        </div>   
        <ul class="list-group">
            ...
            <li class="list-group-item <?=($row['SALDO'] >= 0)?"list-green":"list-red"?>">
                <div class="row toggle" id="dropdown-detail-<?=$i?>" data-toggle="detail-<?=$i?>">
                    <div class="col-xs-8">
                        <?php echo utf8_decode($row['RAZ_SOCIAL'])."(".$row['EMPRESA']."): $".number_format($row['SALDO'],2,',','.');?>
                    </div>
