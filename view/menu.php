                ...
                <div class="menu-list">
                    ...
                    <ul id="menu-content" class="menu-content collapse out">
                        ...
                        <ul class="sub-menu collapse" id="products">
                            <li class="active"><a href="#" onclick="cargarContenido('ERP_PEN_VEN_IMP')">Pendientes de imputaci&oacute;n</a></li>
                        </ul>


                        <li data-toggle="collapse" data-target="#service" class="collapsed">
                          <a href="#"><i class="fa fa-globe fa-lg"></i> Compras <span class="arrow"></span></a>
                        </li>  
                        <ul class="sub-menu collapse" id="service">
                          <li class="active"><a href="#">Pendientes de imputaci&oacute;n</a></li>
                        </ul>

                         <li>
                          <a href="../controller/logout.php">
                              <i class="fa fa-users fa-lg"></i> Cerrar sesi&oacute;n
                          </a>
                        </li>
                    </ul>
             </div>
